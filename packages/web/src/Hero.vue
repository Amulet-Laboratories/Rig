...
<template>
  <section data-rig-hero :data-layout="layout ?? 'split'">
    <div data-rig-hero-content>
      <div v-if="$slots.eyebrow" data-rig-hero-eyebrow>
        <slot name="eyebrow" />
      </div>
      ...
      <div v-if="$slots.actions" data-rig-hero-actions>
        <slot name="actions" />
      </div>
    </div>
