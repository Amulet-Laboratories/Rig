                ...
                <ScrollArea class="wp-location-scroll">
                  <div v-if="filteredWaypoints.length" class="wp-location-list">
                    ...
                    >
                      ...
                      >
                        <Icon :icon="wp.icon" size="xs" style="color: var(--color-primary-foreground, #fff)" />
                      </div>
        ...
        >
          <div v-if="selectedWaypoint" class="wp-detail">
            <div class="wp-detail-header">
              ...
              >
                <Icon :icon="selectedWaypoint.icon" size="lg" style="color: var(--color-primary-foreground, #fff)" />
              </div>
              <div>
            ...
            <Collapsible defaultOpen>
              <template #trigger="{ triggerProps }">
                <span v-bind="triggerProps">Details</span>
              </template>
            ...
            <Card v-for="wp in getSavedWaypoints()" :key="wp.id">
              <div class="wp-saved-card">
                <div
                  ...
                  :style="{ background: categoryConfig[wp.category].color }"
                >
                  <Icon :icon="wp.icon" size="sm" style="color: var(--color-primary-foreground, #fff)" />
                </div>
...
.wp-marker-dot {
  ...
  height: 28px;
  border-radius: 50%;
  border: 2px solid var(--color-primary-foreground, #fff);
  display: flex;
  align-items: center;
  justify-content: center;
  cursor: pointer;
  box-shadow: 0 2px 8px color-mix(in srgb, var(--color-background, #000) 15%, transparent);
