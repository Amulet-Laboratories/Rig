...
// Computed
// ---------------------------------------------------------------------------
function handlePageSort(event: unknown) {
  const e = event as { column: string; direction: 'asc' | 'desc' }
  pageSort.value = { column: e.column, direction: e.direction }
}
    ...
    <Variant title="Default">
      <div class="lh-shell" data-theme="vscode">
        <div class="lh-main">
          ...
          <!-- ---- OVERVIEW ---- -->
          <div v-if="activeTab === 'overview'" class="lh-content" tabindex="0" role="region" aria-label="Log content">
            <!-- Metric cards -->
