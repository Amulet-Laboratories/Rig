...
function generate() {
  ...
  const entryLines = [
    ...
    ' * bridge.css is @import-ed above, so its tokens are already in scope — adding',
    ' * @reference for it as well puts the file in reference mode and Tailwind stops',
    " * emitting its --color-* declarations entirely. Don't reinstate it. */",
