        ...
        <div class="tr-player">
          ...
          <div class="tr-controls">
            <div class="tr-control-buttons">
              ...
              <button class="tr-play-btn" @click="togglePlay">
                <Icon
              ...
              <Tooltip :text="`Repeat: ${player.repeat}`" placement="top">
                <IconButton
                  ariaLabel="Repeat"
                  size="sm"
          ...
          <div class="tr-player-right">
            <Tooltip text="Equalizer" placement="top">
              <IconButton
                ariaLabel="Equalizer"
                size="sm"
      ...
      <div class="tr-shell" data-theme="obsidian">
        <div class="tr-now-view">
          <div v-if="currentTrack" class="tr-now-large">
            <div
              class="tr-now-art"
              :style="{ background: `linear-gradient(135deg, ${currentTrack.coverColor}, color-mix(in srgb, ${currentTrack.coverColor} 40%, #000))` }"
            >
              <Icon icon="codicon:unmute" size="lg" style="color: rgba(255,255,255,0.4)" />
            </div>
            ...
            <div class="tr-now-controls">
              ...
              <button class="tr-play-btn tr-play-lg" @click="togglePlay">
