                    ...
                    <template #default="{ activeId }">
                      ...
                      <div v-if="activeId === 'shape'" class="control-section">
                        <div class="control-group">
                          ...
                          <div class="seed-row">
                            <Input v-model="config.seed" placeholder="Enter a seed..." />
                            <IconButton icon="codicon:refresh" ariaLabel="Randomize" @click="randomizeSeed" />
                          </div>
                        </div>

                        <div class="control-group">
                          <label class="control-label">Segments ({{ config.segments }})</label>
                          <Slider v-model="config.segments" :min="3" :max="12" :step="1" />
                        </div>

                        <div class="control-group">
                          <label class="control-label">Layers ({{ config.layers }})</label>
                          <Slider v-model="config.layers" :min="1" :max="4" :step="1" />
                        </div>

                        <div class="control-group">
                          <label class="control-label">Symmetry</label>
                          <Select v-model="config.symmetry" :options="symmetryOptions" />
                        </div>

                        <div class="control-group">
                          <label class="control-label">Complexity ({{ config.complexity }})</label>
                          <Slider v-model="config.complexity" :min="1" :max="10" :step="1" />
                        </div>

                        <div class="control-group">
                          <label class="control-label">Inner Radius ({{ config.innerRadius.toFixed(2) }})</label>
                          <Slider v-model="config.innerRadius" :min="0.1" :max="0.5" :step="0.05" />
                        </div>

                        <div class="control-group">
                          <label class="control-label">Stroke Weight ({{ config.strokeWeight }})</label>
                          <Slider v-model="config.strokeWeight" :min="1" :max="5" :step="0.5" />
                        </div>

                        <div class="control-group">
                          <Label>
                            <Checkbox v-model="config.showGuides" />
