              ...
              <div v-if="selectedCreature" class="detail-panel">
                ...
                <div class="detail-meta-grid">
                  <div class="detail-field">
                    ...
                    <Badge>{{ selectedCreature.classification }}</Badge>
                  </div>
                  <div class="detail-field">
                    <span class="detail-label">Threat Level</span>
                    <div class="threat-pips">
                      <span
                        v-for="(filled, i) in threatPips(selectedCreature.threatLevel)"
                        :key="i"
                        class="pip"
                        :data-filled="filled || undefined"
                        :style="filled ? { backgroundColor: threatColors[selectedCreature.threatLevel] } : {}"
                      />
                    </div>
                  </div>
                  <div class="detail-field">
                    <span class="detail-label">Encounters</span>
                    <span class="detail-value">{{ selectedCreature.encounters }} reported</span>
                  </div>
                  <div class="detail-field">
                    <span class="detail-label">Habitats</span>
                    <div class="detail-tags">
                      <Badge v-for="h in selectedCreature.habitat" :key="h" size="xs" variant="muted">{{ h }}</Badge>
                    </div>
                  </div>
                </div>
                ...
                <div class="detail-section">
                  <h3 class="detail-section-title">Lore</h3>
